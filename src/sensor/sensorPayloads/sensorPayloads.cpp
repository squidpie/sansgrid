...
uint8_t SensorConfig::sensor_public_key[ SENSOR_KEY ] = { 0x09,0xC4,0x59,0xDC,
	...
	0x25,0xB3,0xC1,0xE2 }; 
uint8_t SensorConfig::control[ CONTROL ] = { 0xFD };
uint8_t SensorConfig::padding[ CONTROL ] = { 0x00 };
...
uint8_t SansgridEyeball::mode[ MODE ] = { 0x00,0x00,0x00,0x01 } ;
...
uint8_t SansgridHeartbeat::dt[ DT ] = { 0x1F };
